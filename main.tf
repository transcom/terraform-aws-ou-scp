  ...
  dynamic "statement" {
    ...
    content {
      ...
      condition {
        ...
        variable = "aws:PrincipalArn"
        values   = ["arn:aws-us-gov:iam::447641181206:role/transfer_usbank", "arn:aws-us-gov:iam::469892416004:role/transfer_usbank", "arn:aws-us-gov:iam::015681133840:role/transfer_usbank", "arn:aws-us-gov:iam::015932076428:role/transfer_usbank", "arn:aws-us-gov:iam::015533997236:role/transfer_usbank", "arn:aws-us-gov:iam::015466132150:user/grafana-logs"]
      }
    }
  }
